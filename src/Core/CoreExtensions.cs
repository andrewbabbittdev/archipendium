...
using Archipendium.Core.Logging;
...
public static class CoreExtensions
{
    ...
    private static DalamudApplicationBuilder ConfigureLogging(this DalamudApplicationBuilder builder)
    {
        builder.Logging.AddDalamudLogger();
