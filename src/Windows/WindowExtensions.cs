...
/// <summary>
/// Provides extension methods for configuring Archipendium windows in a Dalamud application builder.
/// </summary>
public static class WindowExtensions
{
    /// <summary>
    /// Configures the application builder to support Archipendium windows.
    /// </summary>
    ...
    public static DalamudApplicationBuilder ConfigureArchipendiumWindows(this DalamudApplicationBuilder builder)
    {
        return builder.AddWindows<MainWindow>();
    }
}
